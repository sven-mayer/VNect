...
class VNect:
    def __init__(self):
        ...
        self.input_holder = tf.keras.layers.Input(shape=(368, 368, 3))#tf.keras.backend.placeholder(dtype=tf.float32, shape=(None, 368, 368, 3))
        self._build_network()

    def _build_network(self):
        # Conv
        self.conv1 = tf.keras.layers.Conv2D(64, (7,7), padding='same', strides=(2,2), name='conv1')(self.input_holder)
        ...
        self.res2a_branch2a = tf.keras.layers.Conv2D(64, (1,1), padding='valid', name='res2a_branch2a')(self.pool1)
        self.res2a_branch2b = tf.keras.layers.Conv2D(64, (3,3), padding='same', name='res2a_branch2b')(self.res2a_branch2a)
        ...
        # Residual block 2b
        self.res2b_branch2a = tf.keras.layers.Conv2D(64, (1,1), padding='valid', name='res2b_branch2a')(self.res2a)
        self.res2b_branch2b = tf.keras.layers.Conv2D(64, (3,3), padding='same', name='res2b_branch2b')(self.res2b_branch2a)
        ...
        # Residual block 2c
        self.res2c_branch2a = tf.keras.layers.Conv2D(64, (1,1), padding='valid', name='res2c_branch2a') (self.res2b)
        self.res2c_branch2b = tf.keras.layers.Conv2D(64, (3,3), padding='same', name='res2c_branch2b') (self.res2c_branch2a)
        ...
        self.res3a_branch2a = tf.keras.layers.Conv2D(128, (1,1), padding='valid', strides=(2,2), name='res3a_branch2a')(self.res2c)
        self.res3a_branch2b = tf.keras.layers.Conv2D(128, (3,3), padding='same', name='res3a_branch2b') (self.res3a_branch2a)
        ...
        # Residual block 3b
        self.res3b_branch2a = tf.keras.layers.Conv2D(128, (1,1), padding='valid', name='res3b_branch2a')(self.res3a)
        self.res3b_branch2b = tf.keras.layers.Conv2D(128, (3,3), padding='same', name='res3b_branch2b')(self.res3b_branch2a)
        ...
        # Residual block 3c
        self.res3c_branch2a = tf.keras.layers.Conv2D(128, (1,1), padding='valid', name='res3c_branch2a')(self.res3b)
        self.res3c_branch2b = tf.keras.layers.Conv2D(128, (3,3), padding='same', name='res3c_branch2b')(self.res3c_branch2a)
        ...
        # Residual block 3d
        self.res3d_branch2a = tf.keras.layers.Conv2D(128, (1,1), padding='valid', name='res3d_branch2a')(self.res3c)
        self.res3d_branch2b = tf.keras.layers.Conv2D(128, (3,3), padding='same', name='res3d_branch2b')(self.res3d_branch2a)
        ...
        self.res4a_branch2a = tf.keras.layers.Conv2D(256, (1,1), padding='valid', strides=(2,2), name='res4a_branch2a')(self.res3d)
        self.res4a_branch2b = tf.keras.layers.Conv2D(256, (3,3), padding='same',  name='res4a_branch2b')(self.res4a_branch2a)
        ...
        # Residual block 4b
        self.res4b_branch2a = tf.keras.layers.Conv2D(256, (1,1), padding='valid', name='res4b_branch2a')(self.res4a)
        self.res4b_branch2b = tf.keras.layers.Conv2D(256, (3,3), padding='same', name='res4b_branch2b')(self.res4b_branch2a)
        ...
        # Residual block 4c
        self.res4c_branch2a = tf.keras.layers.Conv2D(256, (1,1), padding='valid', name='res4c_branch2a')(self.res4b)
        self.res4c_branch2b = tf.keras.layers.Conv2D(256, (3,3), padding='same', name='res4c_branch2b')(self.res4c_branch2a)
        ...
        # Residual block 4d
        self.res4d_branch2a = tf.keras.layers.Conv2D(256, (1,1), padding='valid', name='res4d_branch2a')(self.res4c)
        self.res4d_branch2b = tf.keras.layers.Conv2D(256, (3,3), padding='same', name='res4d_branch2b')(self.res4d_branch2a)
        ...
        # Residual block 4e
        self.res4e_branch2a = tf.keras.layers.Conv2D(256, (1,1), padding='valid', name='res4e_branch2a')(self.res4d)
        self.res4e_branch2b = tf.keras.layers.Conv2D(256, (3,3), padding='same', name='res4e_branch2b')(self.res4e_branch2a)
        ...
        # Residual block 4f
        self.res4f_branch2a = tf.keras.layers.Conv2D(256, (1,1), padding='valid', name='res4f_branch2a')(self.res4e)
        self.res4f_branch2b = tf.keras.layers.Conv2D(256, (3,3), padding='same', name='res4f_branch2b')(self.res4f_branch2a)
        ...
        # Residual block 5a
        self.res5a_branch2a_new = tf.keras.layers.Conv2D(512, (1,1), padding='valid', name='res5a_branch2a_new')(self.res4f)
        self.res5a_branch2b_new = tf.keras.layers.Conv2D(512, (3,3), padding='same', name='res5a_branch2b_new')(self.res5a_branch2a_new)
        ...
        # Residual block 5b
        self.res5b_branch2a_new = tf.keras.layers.Conv2D(256, (1,1), padding='valid', name='res5b_branch2a_new')(self.res5a)
        self.res5b_branch2b_new = tf.keras.layers.Conv2D(128, (3,3), padding='same', name='res5b_branch2b_new')(self.res5b_branch2a_new)
        self.res5b_branch2c_new = tf.keras.layers.Conv2D(256, (1,1), padding='valid', name='res5b_branch2c_new')(self.res5b_branch2b_new)

        # Transpose Conv
        self.res5c_branch1a = tf.keras.layers.Conv2DTranspose(63, (4,4), activation=None, strides=2, padding='same', use_bias=False, name='res5c_branch1a')(self.res5b_branch2c_new)
        ...
        self.bn5c_branch2a = tf.keras.layers.BatchNormalization(scale=True, trainable=self.is_training, name='bn5c_branch2a', 
                                                               beta_initializer='ones', gamma_initializer='zeros',
    moving_mean_initializer='zeros', moving_variance_initializer='zeros')(self.res5c_branch2a)
        ...
        self.res5c_bone_length_sqr = tf.math.add(tf.math.add(self.res5c_delta_x_sqr, self.res5c_delta_y_sqr),
        ...
        self.res5c_branch2b = tf.keras.layers.Conv2D(128, (3,3), padding='same', name='res5c_branch2b')(self.res5c_branch2a_feat)
        self.res5c_branch2c = tf.keras.layers.Conv2D(84, (1,1), padding='valid', activation=None, use_bias=False, name='res5c_branch2c')(self.res5c_branch2b)
